...
{
	return InitializeShader(device, hwnd, L"Shader/TextureShader.hlsl");
}
...
bool TextureShaderClass::Render(ID3D11DeviceContext* context, int indexCount, XMMATRIX worldMat, XMMATRIX viewMat, XMMATRIX projMat, ID3D11ShaderResourceView* texture)
{
...
bool TextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, LPCWSTR fileName)
{
...
void TextureShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMsg, HWND hwnd, LPCWSTR fileName)
{
	// Print debug message
...
bool TextureShaderClass::SetShaderParameters(ID3D11DeviceContext* context, XMMATRIX worldMat, XMMATRIX viewMat, XMMATRIX projMat, ID3D11ShaderResourceView* texture)
{
